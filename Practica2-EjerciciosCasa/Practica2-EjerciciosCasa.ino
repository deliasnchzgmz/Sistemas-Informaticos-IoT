      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/H\">here</a> to set servo to 180 degrees.<br>");
            client.print("Click <a href=\"/M\">here</a> to set servo to 90 degrees.<br>");
            client.print("Click <a href=\"/L\">here</a> to set servo to 0 degrees.<br>");
        ...
        if (currentLine.endsWith("GET /H")) {
          ...
          Serial.println("------------");
          Serial.println("------------");*/
          servo.write(checkLimits(0, 180, 180));
          sleep(2);
        }
        if (currentLine.endsWith("GET /M")) {
          ...
          Serial.println("------------");
          Serial.println("------------");*/
          servo.write(checkLimits(0, 180, 90));
          sleep(2);
        }
        if (currentLine.endsWith("GET /L")) {
          ...
          Serial.println("------------");
          Serial.println("------------");*/
          servo.write(checkLimits(0, 180, 0));
          sleep(2);
        }
      }
    }
